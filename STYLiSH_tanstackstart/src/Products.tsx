import type Props from './types/styleComponentsType';
import { Link, useSearch } from '@tanstack/react-router';
import { useInfiniteQuery } from '@tanstack/react-query';
import { ProductColor } from './styledComponents/Products.style';
import { getQueryClientFetchData } from './main';
import { type RefObject, useContext, useEffect, useReducer, useRef, useState } from 'react';
import { useInView } from 'react-intersection-observer';
import api from './utils/api';
import { type ProductsSearch, type ProductDetailsData, type ProductDetails } from './types/productType';
import { Route } from './routes';

const useIntersectionObserver = (ref: RefObject<undefined>, options: {}) => {
